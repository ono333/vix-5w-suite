...
SHORT_MAP = {
    ...
    ("2026-04-09", 45.0, "2026-04-17", 1.45): ["V1", "V5A", "V5A"],
    # ^ chat Apr 9 plan: V1 2x45C + V5 2x45C; FIFO trips are (2,1,1) lots
    ("2026-04-09", 46.0, "2026-04-17", 1.22): ["V5B"],
    ("2026-04-09", 46.0, "2026-04-17", 1.28): ["V4"],
    # Apr 17 per Shin's explicit instruction ("V1 40C x2, V5 39C x3"):
    ("2026-04-17", 39.0, "2026-04-24", 1.30): ["V5A", "V5A"],  # V5 primary x2
    ("2026-04-17", 39.0, "2026-04-24", 1.33): ["V5B"],         # V5 secondary x1
    ...
    # May 7 roll: no chat record recovered — PROPOSED by roll-chain
    # continuity (V1 held the 40C line, V5A the other). CONFIRM WITH SHIN.
    ("2026-05-07", 40.0, "2026-05-15", 0.68): ["V1"],
    ("2026-05-07", 39.0, "2026-05-15", 0.80): ["V5A"],
    ("2026-05-07", 39.0, "2026-05-15", 0.82): ["V5A"],
    # Jun 18 onward: chat-confirmed single consolidated book -> CONS (default)
}
